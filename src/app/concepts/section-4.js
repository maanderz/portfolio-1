    ...
    <div className={styles.concepts_main_container} style={{ marginRight: '0', width: '50%' }}>
      ...
      <div className={styles.intro_links}>
        <div style={{ fontSize: '1.25rem' }}>
          ...
          <div className={styles.concept_description_left}>Everything we do comes with associated risks. Risks associated with computers include privacy and security issues. Data is collected by companies when we use their services, and when they have a security breach our privacy becomes exposed. Malware is a security issue we must be mindful of. Hackers have various tools to attack our systems for our personal information such as phishing and viruses. We must be cautious about how we use our computers to be able to protect ourselves while enjoying all the benefits of being connected.</div>
        </div>  
      </div>
    </div>
  );
